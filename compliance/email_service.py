...
FROM_EMAIL = os.getenv("FROM_EMAIL", "noreply@claverica.com")
...
def send_tac_email(to_email: str, tac_code: str, user_name: str = "User"):
...
def send_kyc_submitted_email(to_email: str, user_name: str, verification_id: str):
...
def send_kyc_approved_email(to_email: str, user_name: str, compliance_level: str):
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="success-box">
                    ...
                    <p><strong>Approved Date:</strong> {datetime.utcnow().strftime('%B %d, %Y')}</p>
                </div>
...
def send_withdrawal_confirmation_email(to_email: str, user_name: str, amount: float, currency: str):
