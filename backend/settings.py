...
MIDDLEWARE = [
    ...
    'backend.middleware.RequestLoggingMiddleware',  # Custom middleware
]
...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@claverica.com')
...
SENSITIVE_OPERATION_RATE_LIMIT = '10/hour'
...
# Import Decimal for transaction limits
from decimal import Decimal
