...
class CardViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Card.objects.filter(user=self.request.user).order_by('-is_primary', '-created_at')
    ...
    def perform_create(self, serializer):
        ...
        existing_cards = Card.objects.filter(user=self.request.user).count()
