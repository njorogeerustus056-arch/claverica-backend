...
urlpatterns = [
    ...
    path('<uuid:transaction_id>/', views.get_transaction_detail_view, name='transaction_detail'),
    path('<uuid:transaction_id>/update/', views.update_transaction_view, name='update_transaction'),
    path('<uuid:transaction_id>/delete/', views.delete_transaction_view, name='delete_transaction'),
