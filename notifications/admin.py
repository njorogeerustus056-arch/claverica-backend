...
class NotificationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Related Information', {
            'fields': ('related_transaction_id', 'related_account_id', 'metadata'),
            'classes': ('collapse',)
        }),
        ('Timestamps', {
...
class NotificationTemplateAdmin(admin.ModelAdmin):
    list_display = (
        'template_type', 'notification_type', 'priority_badge',
    ...
    fieldsets = (
        ('Template Information', {
            'fields': ('template_type', 'notification_type', 'priority', 'is_active')
        }),
        ('Content Templates', {
        ...
        ('Action', {
            'fields': ('action_url_template', 'action_label')
        }),
        ('Timestamps', {
            'fields': ('created_at', 'updated_at'),
            'classes': ('collapse',)
...
class NotificationLogAdmin(admin.ModelAdmin):
    list_display = (
        'notification', 'channel', 'status_badge', 'sent_at',
...
class NotificationDeviceAdmin(admin.ModelAdmin):
    list_display = (
        'user', 'device_type', 'device_name', 'is_active_badge',
    ...
    fieldsets = (
        ('Device Information', {
            'fields': ('user', 'device_type', 'device_name', 'device_token')
        }),
        ('Status', {
            'fields': ('is_active',)
        }),
