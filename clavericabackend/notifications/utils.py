"""
Utility functions for the notifications system, now with Pusher integration
"""
...
def push_event(channel: str, event: str, data: dict):
    """
    Sends a real-time event to Pusher.
    """
...
# All of them call `create_notification`, so Pusher triggers automatically
# ------------------------------
...
# ------------------------------
# All other functions (send_card_notification, send_kyc_notification, send_savings_goal_notification, etc.)
# remain unchanged — they all use create_notification, so Pusher is automatically triggered
# ------------------------------
